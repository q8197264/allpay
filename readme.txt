...
三、接口调用
    ...
    1.快速调用开发
        ...
        *异步通知
        ...
        $data = $this->payapi->notify( $pay_id );
...
四、接口测试
    ...
    微信支付二维码测试：
    http://component.yaofang.cn/allpay/cy_allpay/pay?out_trade_no=2494695&total_fee=1&pay_id=25&notify_url=http://m.yaofang.cn/pay/notify/25&return_url=http://m.yaofang.cn/pay/return_url/25
